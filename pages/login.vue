      ...
      <div class="w-full rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0 bg-gray-800 border-gray-700 mt-10">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form class="space-y-4 md:space-y-6" action="#">
            ...
            <button type="button" class="w-full text-white bg-base-600 hover:bg-base-700 focus:ring-4 focus:outline-none focus:ring-base-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-base-600 dark:hover:bg-base-700 dark:focus:ring-base-800" @click="login()">Giriş Yap</button>
            ...
            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
              Bir hesabınız yok mu? <NuxtLink to="/register" class="font-medium hover:underline text-base-500">Kayıt Ol</NuxtLink>
            </p>
          </form>
        </div>
      </div>
