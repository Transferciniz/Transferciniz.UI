<template>
  <div class="flex flex-col">
    ...
    <USlideover v-model="isAddWaypointModalVisible" :ui="{wrapper:'fixed inset-0 flex z-[50]'}" side="top">
    ...
    <USlideover v-model="isWaypointEditModalVisible" :ui="{wrapper:'fixed inset-0 flex z-[50]'}" side="top">
      <div class="flex flex-col">
    ...
    <USlideover v-model="isUserEditModalVisible" :ui="{wrapper:'fixed inset-0 flex z-[51]'}" side="top">
      <UCard>
        <template #header>
